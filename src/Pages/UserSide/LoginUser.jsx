  ...
  return (
    <FormContainer>
      ...
      <form
        ...
        className="bg-white shadow-2xl md:rounded-3xl grid grid-rows-1 sm:grid-cols-2 grid-cols-1 lg:w-[60rem] lg:h-[31rem] md:w-[50rem] md:h-[26rem] w-[100%] h-[100%] "
      >
        <div className="flex flex-col justify-center items-center w-full relative">
          <div className="absolute logo text-[#997af0] top-5 z-50 left-[50%] transform translate-x-[-50%]">
            <span className="font-bold text-[2.5rem] select-none font-comforter2">
              FILIA
            </span>
          </div>
          {/* col 1 ============= start */}
          ...
          <span className="mt-3 font-thin text-red-500 ">
            don't have membership ? <Link to="/register">Take one</Link>{" "}
          </span>
        </div>
        {/* col 1 ============= end */}
        {/* col 2 ============= start */}
        <div className="sm:block hidden m-auto h-[100%]">
          <img
            src={login1}
            alt=""
            className="h-full md:rounded-e-3xl select-none"
          />
        </div>
      </form>
    </FormContainer>
